...
TOPIC_KEYWORDS: Dict[str, List[str]] = {
    "coding_and_development": [
        ...
        "cursor", "windsurf", "vscode", "copilot", "webpack", "vite",
        "nextjs", "django", "flask", "fastapi", "express", "postgres",
        "mongodb", "redis", "graphql", "rest api", "websocket", "regex",
    ],
    "ai_and_machine_learning": [
        "ai", "artificial intelligence", "machine learning", "llm",
        "gpt", "claude", "model", "prompt", "chatgpt", "openai",
        "anthropic", "neural", "training", "fine-tune", "embedding",
        "vector", "rag", "agent", "transformer", "langchain", "token",
        "inference", "diffusion", "stable diffusion", "midjourney",
        "ai agent", "autonomous", "mcp", "function calling",
    ],
    "career_and_professional": [
        ...
        "project management", "agile", "scrum", "tpm", "program manager",
        "stakeholder", "performance review", "negotiation", "networking",
    ],
    "health_and_fitness": [
        "health", "fitness", "workout", "exercise", "diet", "nutrition",
        "supplement", "protein", "creatine", "vegan", "weight", "muscle",
        "running", "triathlon", "marathon", "cycling", "swimming",
        "sleep", "meditation", "fasting", "calories", "macro",
        "blueprint", "bryan johnson", "longevity", "biohack",
    ],
    "finance_and_investing": [
        "invest", "stock", "trading", "portfolio", "market", "crypto",
        "bitcoin", "ethereum", "finance", "budget", "savings", "retirement",
        "401k", "ira", "dividend", "alpaca", "broker", "forex",
        "franchise", "revenue", "profit", "roi", "real estate",
    ],
    "writing_and_content": [
    ...
    "productivity_and_tools": [
        ...
        "automation", "zapier", "make.com", "shortcut", "template",
...
TECH_PATTERNS = [
    ...
    "cursor", "windsurf", "claude code", "copilot", "chatgpt", "vscode",
    "neovim", "vim", "postgres", "postgresql", "mongodb", "redis", "mysql",
    "grafana", "prometheus", "datadog", "splunk", "jenkins", "vercel",
    "netlify", "supabase", "firebase", "stripe", "alpaca", "tailwind",
    "shadcn", "langchain", "llamaindex", "pinecone", "chromadb",
]
